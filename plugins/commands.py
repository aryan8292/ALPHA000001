...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('CLONE BOT', callback_data="shortlink_info")
                ],[
                    InlineKeyboardButton('💰 Buy Premium for adz Free Movies ✅', callback_data='buy_premium')
                ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        m=await message.reply_text("<i><b>0000..</b></i>")
        await m.edit_text("<b><i>00000</i></b>")
    ...
    if AUTH_CHANNEL and not await is_req_subscribed(client, message):
        ...
        [
            InlineKeyboardButton(
                "🌟 JOIN🌟", url="https://t.me/+pRHggLGubqI2YzRl"
            )
        ]
        ]
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                ...
                                InlineKeyboardButton('𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥', url=f'https://t.me/PANDITXG')
                            ]
                        ]
                    )
                )
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          ...
                          InlineKeyboardButton("𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥", url='https://t.me/PANDITXG')
                            ]
                        ]
                    )
                )
        ...
        for file in files:
            ...
            if not await check_verification(client, message.from_user.id) and VERIFY == True:
                btn = [[
                    ...
                    InlineKeyboardButton("Hᴏᴡ Tᴏ Vᴇʀɪғʏ", url='https://t.me/Ary_botz/2')
                ]]
                await message.reply_text(
