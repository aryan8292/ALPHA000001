...
PICS = (environ.get('PICS', 'https://envs.sh/HMt.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/HMt.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/ARY_BOTZ/4")
...
CHNL_LNK = environ.get('CHNL_LNK', 'http://t.me/Ary_botz')
WRM = environ.get('WRM', 'https://t.me/Ary_botz')
MSG_ALRT = environ.get('MSG_ALRT', '💖 PANDJI JINDA-BAD 💖')
